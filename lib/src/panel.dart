...
class SlidingUpPanel extends StatefulWidget {
  ...
  SlidingUpPanel(
      ...
      : assert(0 <= backdropOpacity && backdropOpacity <= 1.0),
        assert(0 < snapPoint && snapPoint < 1.0),
        super(key: key);
...
class _SlidingUpPanelState extends State<SlidingUpPanel> with SingleTickerProviderStateMixin {
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                          ...
                          width:
                              MediaQuery.of(context).size.width - widget.margin.horizontal - widget.padding.horizontal,
                          child: Container(
                      ...
                      Positioned(
                        top: widget.slideDirection == SlideDirection.UP ? 0.0 : null,
                        bottom: widget.slideDirection == SlideDirection.DOWN ? 0.0 : null,
                        width: MediaQuery.of(context).size.width - widget.margin.horizontal - widget.padding.horizontal,
                        child: Container(
    ...
    return Listener(
      onPointerSignal: (p) {
        if (p is PointerScrollEvent) {
          ...
          _scrollEventTimer = Timer(const Duration(milliseconds: 50), () => _onGestureEnd(_vt.getVelocity()));
        }
      },
  ...
  void _onGestureEnd(Velocity v) {
    ...
    double d2Snap = (widget.snapPoint - _ac.value).abs(); // large value if null results in not every being the min
